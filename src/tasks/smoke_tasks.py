"""
src/tasks/smoke_tasks.py
========================
Factory functions for the minimal smoke-test pipeline (2 tasks, ~3-8 minutes).
"""
...
def create_task_latex_smoke(
    author: Agent,
    context: list[Task],
    run_folder: Path | None = None,
) -> Task:
    """Single combined task for --smoke mode. Writes ALL 11 files in one pass."""
...
def create_smoke_tasks(
    ...
    from src.tasks.research_tasks import create_task_outline
