"""
src/tasks/latex_split_tasks.py
===============================
Factory functions for the 3-way LaTeX split architecture (writers A/B/C).
"""
...
from src.tasks.writing_tasks import latex_shared_rules

_STAGING = "outputs/current"


def create_task_latex_a(
    author: Agent,
    context: list[Task],
    ...
    rules = latex_shared_rules(chapters_dir, bib_path, latex_dir)
    return Task(
        description=f"""
