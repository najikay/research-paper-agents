"""
src/runner/tex_math.py
======================
Math-mode helpers for the LaTeX sanitizer: bare-symbol wrapping, PNG dimension
probing, and wide-figure upgrading. Code moved verbatim from main.py.
"""
